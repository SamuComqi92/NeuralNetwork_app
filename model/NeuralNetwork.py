...
from sklearn.metrics import precision_score,recall_score,f1_score, accuracy_score, confusion_matrix, r2_score, precision_recall_curve, 
                            roc_auc_score, roc_curve, mean_squared_error, mean_absolute_error mean_absolute_percentage_error
