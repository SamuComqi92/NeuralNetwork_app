...
if uploaded_file is not None:   
    ...
    if step_further == 7 :
        ...
        Model = NeuralNetwork_module.NeuralNet(task=Task, function = Function_, Hidden_layers = Hidden_layers, algo = Algo, batch = None, alpha = float(Alpha), decay = float(Decay), 
